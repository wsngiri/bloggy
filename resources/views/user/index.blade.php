<x-app-layout>
    ...
    <h3 class="mt-3 mb-6">Users Table</h3>
    <div class="shadow-md sm:rounded-lg">
        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            ...
            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                ...
                <td class="px-6 py-3 font-medium text-gray-900 dark:text-white ">{{ $item->username }}</td>
                <td class="px-6 py-3 font-medium text-gray-900 dark:text-white ">{{ $item->name }}</td>
                <td class="px-6 py-3 font-medium text-gray-900 dark:text-white ">{{ $item->role }}</td>
                <td class="px-6 py-3">
                    <div class="flex items-center">
                        <a class="text-sky-500 hover:underline mr-2" href="{{ route('users.edit', ['id' => $item->id]) }}">Edit</a>
